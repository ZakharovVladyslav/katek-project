export default function tableHeadersSelection(headers, results) {
    ...
    if (table.innerHTML === '') {
        for (let i = 0; i < 9; i++) {
            ...
            for (let j = 0; j < 3; j++) {
                ...
                showResButton.removeEventListener('click', () => {});
                ...
                filtersForm.removeEventListener('click', e => {});

                filtersForm.addEventListener('submit', e => {
                    e.preventDefault();
                })

                filtersForm.removeEventListener('submit', e => {});
    ...
    filtersForm.removeEventListener('submit', () => {});
