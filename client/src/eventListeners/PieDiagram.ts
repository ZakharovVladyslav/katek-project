...
export default function handlePieDiagramCheckboxChange() {
    const dataPieInput = document.querySelector('#content-input-pieDiagram') as HTMLInputElement;
    ...
    const diagrammLabel = document.querySelector('#pie-diagramm-label') as HTMLLabelElement;
