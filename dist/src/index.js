...
import CompleteTable from './Table/Complete-table.js';
import getFilters from './DB/Data-filtering.js';
import CsvToArray from './Data/Convert-csv.js';
import SummaryTable from './Table/Summary-table.js';
import DropdownValues from './Data/Dropdown-values.js';
import Diagram from './Data/Diagram.js';
import CustomStorage from './Storage/Local-Storage.js';
import fillStorage from './Storage/FillStorage.js';
import fetchData from './DB/FetchDbJSON.js';
import DBQuery from './DB/DBQuery.js';
import PopUpHeadersSelect from './Table/PopUpHeadersSelect.js';
import CountpassCounter from './Data/CountpassCounter.js';
import LoginWindow from './login-form/login-window.js';
